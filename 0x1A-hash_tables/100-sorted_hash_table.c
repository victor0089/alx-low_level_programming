...
/**
 * shash_table_create - create sorted hash table given size vico
 * @size: size
...
/**
 * insert_to_sorted_list - compareabcsandinsert nodeintolist(for printing)
...
/**
 * shash_table_print_rev - print key/values ofin reverse order
 * @ht: hash table
 */
